# Contributing to oxidized-physics
...
```bash
# 1. Fork and clone
git clone https://github.com/oxidized-mc/physics.git
cd physics
...
`oxidized-physics` is a library crate in the
...
Use `physics` as the scope for all changes to this crate.
